...
### Receiving Work
Accept tickets where `owner: environment-artist` and `status: OPEN`.
...
Read the level design spec in `docs/design/systems/` or linked documents in the ticket before beginning scene construction.
