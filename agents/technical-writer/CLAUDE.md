...
### Receiving Work
Accept tickets where `owner: technical-writer` and `status: OPEN`. Also proactively audit `docs/` at the start of each milestone for stale or missing documentation and create `TASK` tickets for gaps.
