...
func register_tests() -> void:
	# Constants
	add_test("ping_range_is_80", _test_ping_range_is_80)
...
func _test_ping_range_is_80() -> void:
	assert_equal(Scanner.PING_RANGE, 80.0,
		"PING_RANGE should be 80.0 per design spec")
