...
| Recycler Machine (3D) | `recycler-machine.md` | TICKET-0043, TICKET-0044, TICKET-0045 |
| Recycler Panel (UI) | `recycler-panel.md` | TICKET-0045 |
...
3. **Recycler machine:** Physical 1.8m x 1.2m x 1.4m machine with input hopper (left), output tray (right), built-in screen (front), status light, and power indicator. Greybox with flat materials, 1500-4000 tri budget.
4. **Recycler panel:** Screen-space overlay representing the machine's built-in screen. Mini-picker for input selection filters to valid recipes only. Ghost icon shows expected output during processing.
5. **Ship interior:** 12m x 8m main bay with 2m x 3m entry corridor. Two 3m x 3m module placement zones. Interact-to-enter and interact-to-exit (no auto-transition). Fade-to-black scene transition.
6. **Heat bar:** Dual-range indicator — both 0% (freezing) and 100% (overheating) are dangerous. Tick marks at 25%/75% show safe zone.
...
- Recycler machine and panel are paired — `recycler-machine.md` defines 3D form, `recycler-panel.md` defines the UI overlay. Machine screen brightens when panel is open.
- Recycler machine: 1500-4000 tri greybox, `mesh_recycler_module.glb`, goes in `game/assets/meshes/machines/`
...
- 2026-02-23 [ui-ux-designer] All 4 wireframes complete. Ship globals HUD (bottom-right), ship stats sidebar (inventory addon), Recycler panel (full overlay), ship interior layout (12x8m bay, 2 module zones). Status → DONE. Commit c0211f3, merged via PR #20 (merge commit 0ad9807).
- 2026-02-23 [ui-ux-designer] Added Recycler machine 3D form factor wireframe (recycler-machine.md). Updated Recycler panel wireframe to reference physical machine and screen relationship. 5 wireframes total.
