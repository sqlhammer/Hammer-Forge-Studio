...
- [x] `tech_tree_panel.gd`: create `tech_tree_panel.tscn`; move entire panel (dim layer, main panel, node cards with icons, Line2D connectors, detail panel, confirm dialog with overlay) to scene; remove LAYOUT_IN_READY violations (layer, process_mode, visible at lines 66–68)
- [x] Replace all `_build_ui()` node construction with `@onready` vars
- [x] Verify tech tree opens, displays nodes/connectors, and research unlock flow works correctly
...
- 2026-03-03 [gameplay-programmer] DONE — commit 6d63d2b, PR https://github.com/sqlhammer/Hammer-Forge-Studio/pull/337
