...
- 2026-03-01 [systems-programmer] DONE — commit 011a55f, PR #272 (https://github.com/sqlhammer/Hammer-Forge-Studio/pull/272) merged to main. All three biome scripts updated to use DeepResourceNode.new() for deep deposits. Removed unused DEEP_NODE_YIELD_RATE constants from rock_warrens and shattered_flats. Fixed debris_field naming logic to use local is_deep flag.
