...
- 2026-03-01 [systems-programmer] DONE — renamed Global.log() to Global.debug_log() in method definition (Global.gd) and all 280 call sites across 49 files. Commit d08ba04, PR https://github.com/sqlhammer/Hammer-Forge-Studio/pull/271 merged to main.
